...
@section('content')
<form method="post" action="{{ route('botusers.update', ['id'=>$id->id]) }}" enctype="multipart/form-data">
    @method('PUT')
    @csrf
    @include('backend.post.form')
    <button class="btn btn-primary" type="submit">Save</button>
    <a href="{{ route('botusers.index') }}"><button type="button" class="btn btn-danger">Cansel</button></a>
</form>
@endsection
@section('tinyconf')
